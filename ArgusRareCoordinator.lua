...
local RareIDs = {
	...
	126899, -- Jed'hin Champion Vorsuk
...
RareNamesLocalized['enUS'][123689] = "Talestra the Vile"
RareNamesLocalized['enUS'][125820] = "Imp Mother Laglath"
RareNamesLocalized['enUS'][122912] = "Commander Sathrenael"
RareNamesLocalized['enUS'][124775] = "Commander Endaxis"
RareNamesLocalized['enUS'][124804] = "Tereck the Selector"
RareNamesLocalized['enUS'][125479] = "Tar Spitter"
RareNamesLocalized['enUS'][120393] = "Siegemaster Voraan"
RareNamesLocalized['enUS'][125388] = "Vagath the Betrayed"
RareNamesLocalized['enUS'][123464] = "Sister Subversia"
RareNamesLocalized['enUS'][126419] = "Naroua"
RareNamesLocalized['enUS'][125824] = "Khazaduum"
RareNamesLocalized['enUS'][122911] = "Commander Vecaya"
RareNamesLocalized['enUS'][127288] = "Houndmaster Kerrax"
RareNamesLocalized['enUS'][126040] = "Puscilla"
RareNamesLocalized['enUS'][127705] = "Mother Rosula"
RareNamesLocalized['enUS'][127376] = "Chief Alchemist Munculus"
RareNamesLocalized['enUS'][126946] = "Inquisitor Vethroz"
RareNamesLocalized['enUS'][122999] = "Gar'zoth"
RareNamesLocalized['enUS'][127090] = "Admiral Rel'var"
RareNamesLocalized['enUS'][127096] = "All-Seer Xanarian"
RareNamesLocalized['enUS'][122958] = "Blistermaw"
RareNamesLocalized['enUS'][126199] = "Vrax'thul"
RareNamesLocalized['enUS'][126115] = "Ven'orn"
RareNamesLocalized['enUS'][126208] = "Varga"
RareNamesLocalized['enUS'][126338] = "Wrath-Lord Yarez"
RareNamesLocalized['enUS'][127118] = "WorldSplitter Skuul"
RareNamesLocalized['enUS'][126254] = "Lieutenant Xakaar"
RareNamesLocalized['enUS'][127581] = "The Many-Faced Devourer"
RareNamesLocalized['enUS'][122947] = "Mistress Il'thendra"
RareNamesLocalized['enUS'][127703] = "Doomcaster Suprax"
RareNamesLocalized['enUS'][127700] = "Squadron Commander Vishax"
RareNamesLocalized['enUS'][127300] = "Void Warden Valsuran"
RareNamesLocalized['enUS'][127084] = "Commander Texlaz"
RareNamesLocalized['enUS'][127706] = "Rezira the Seer"
RareNamesLocalized['enUS'][127291] = "Watcher Aival"
RareNamesLocalized['enUS'][126867] = "Venomtail Skyfin"
RareNamesLocalized['enUS'][126860] = "Kaara The pale"
RareNamesLocalized['enUS'][126869] = "Captain Faruq"
RareNamesLocalized['enUS'][126912] = "Skreeg the Devourer"
RareNamesLocalized['enUS'][124440] = "Overseer y'Beda"
RareNamesLocalized['enUS'][126913] = "Slithon the last"
RareNamesLocalized['enUS'][126899] = "Jed'hin Champion Vorsuk"
RareNamesLocalized['enUS'][126866] = "Vigilant Kuro"
RareNamesLocalized['enUS'][126908] = "Zul'tan the Numerous"
RareNamesLocalized['enUS'][126862] = "Baruut the Bloodthirsty"
RareNamesLocalized['enUS'][126896] = "Herald of Chaos"
RareNamesLocalized['enUS'][126865] = "Vigilant Thanos"
RareNamesLocalized['enUS'][126900] = "Instructor Tarahna"
RareNamesLocalized['enUS'][126852] = "Wrangler Kravos"
RareNamesLocalized['enUS'][126887] = "Ataxon"
RareNamesLocalized['enUS'][126868] = "Turek the Lucid"
RareNamesLocalized['enUS'][125498] = "Overseer Y'Morna"
RareNamesLocalized['enUS'][126864] = "Feasel the Muffin Thief"
RareNamesLocalized['enUS'][127704] = "soultender Videx"
RareNamesLocalized['enUS'][125497] = "Overseer Y'Sorna"
RareNamesLocalized['enUS'][126910] = "Commander Xethgar"
RareNamesLocalized['enUS'][122838] = "Shadowcaster Voruun"
RareNamesLocalized['enUS'][126815] = "Soultwisted Monstrosity"
RareNamesLocalized['enUS'][126885] = "Umbraliss"
RareNamesLocalized['enUS'][126889] = "Sorolis the Ill-Fated"
RareNamesLocalized['enUS'][126898] = "Sabuu"
...
RC.res.texture:SetTexture([[Interface\AddOns\ArgusRareCoordinator\resize.tga]])
...
RC.left.minimizeicon.texture:SetTexture([[Interface\AddOns\ArgusRareCoordinator\minus.tga]])
...
RC.left.settingsicon.texture:SetTexture([[Interface\AddOns\ArgusRareCoordinator\settings.tga]])
...
for i=0, #RareIDs do
	...
	RC.mid.button[i].icon.texture:SetTexture([[Interface\AddOns\ArgusRareCoordinator\announce.tga]])
...
for i=0, #RareIDs do
	if i ~= 0 then
		...
		RC.mid.map[i].marker:SetTexture([[Interface\AddOns\ArgusRareCoordinator\marker.tga]])
...
RC.message.closeicon.texture:SetTexture([[Interface\AddOns\ArgusRareCoordinator\plus.tga]])
...
RCminimized.maximizeicon.texture:SetTexture([[Interface\AddOns\ArgusRareCoordinator\plus.tga]])
...
RCnotify.closeicon.texture:SetTexture([[Interface\AddOns\ArgusRareCoordinator\plus.tga]])
...
local function updateText(self,elapsed)
    ...
    if total >= 10 then
				...
				if RC.left ~= nil then
					...
					if RC.left.icon ~= nil then
						if RareAv[v.id] ~= nil then
							if RareAv[v.id] then
								RC.left.icon[k].texture:SetTexture([[Interface\AddOns\ArgusRareCoordinator\green.tga]])
							else
								RC.left.icon[k].texture:SetTexture([[Interface\AddOns\ArgusRareCoordinator\red.tga]])
							end
						else
		...
		--						RC.left.icon[i].texture:SetTexture([[Interface\AddOns\ArgusRareCoordinator\green.tga]])
		--					else
		--						RC.left.icon[i].texture:SetTexture([[Interface\AddOns\ArgusRareCoordinator\red.tga]])
		--					end
		--				else
...
function RC:ShowOrHide(...)
	if IsInXRealmGrp() then
		...
		if GetCurrentMapAreaID() == 1135 or GetCurrentMapAreaID() == 1171 then
			RareAlive = {}
			if minimized then
				RCminimized:Show()
			else
